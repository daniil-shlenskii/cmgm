...
SAVE_DIR="/path/to/checkpoints/tinygsm_distill" # checkpoint output directory
MDLM_CKPT="/path/to/mdlm.ckpt"                  # MDLM teacher checkpoint to distill from
...
python -u -m main \
  ...
  algo.p_distill=0.25 \
  algo.distill_teacher_ckpt_path="${MDLM_CKPT}" \
