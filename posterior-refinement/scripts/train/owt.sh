...
DATA_DIR="/path/to/openwebtext"     # dataset cache directory
SAVE_DIR="/path/to/checkpoints/owt" # checkpoint output directory
...
python -u -m main \
  ...
  sampling.block_length=1024 \
  sampling.steps_per_block=1024 \
