...
SAVE_DIR="/path/to/checkpoints/tinygsm_init" # checkpoint output directory
MDLM_CKPT="/path/to/mdlm.ckpt"               # MDLM checkpoint to initialize from
...
python -u -m main \
  ...
  algo.init_teacher_ckpt_path="${MDLM_CKPT}" \
  algo.init_teacher_kind=mdlm \
