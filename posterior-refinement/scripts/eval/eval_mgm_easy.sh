...
python -u -m main \
  hydra.run.dir=outputs/sflm_sudoku_easy/mgm_sflm_sudoku_easy_eval \
  mode=ppl_eval \
  seed=1 \
  ...
  eval.checkpoint_path=/home/ivanov/posterior-refinement/checkpoints/sudoku_mgm_easy/checkpoints/last.ckpt \
  ...
  sampling.steps=1 \
  +wandb.offline=true \
  2>&1 | tee /home/ivanov/posterior-refinement/mgm_eval_easy.log
